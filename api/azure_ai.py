...
class AzurePIIRedaction():
    def __init__(self):
        self.language_endpoint = os.getenv("PII_LANGUAGE_ENDPOINT")
        self.language_key = os.getenv("PII_LANGUAGE_KEY")
        self.container_in = os.getenv("PII_STORAGE_ACCOUNT_CONTAINER_IN")
